...
namespace ITI.TP_UserBasedRecommendation
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            if (CsvLoader<bool>.FileExist("u.user")) throw new FileNotFoundException("the user data file is not in the data folder");
            if (CsvLoader<bool>.FileExist("u.item")) throw new FileNotFoundException("the movie data file is not in the data folder");
            if (CsvLoader<bool>.FileExist("u.data")) throw new FileNotFoundException("the score data file is not in the data folder");
